...
sweetIsTooLong = undefined -- FIXME
...
redundantGreet :: String -- ^ greeting
               -> String -- ^ name
               -> String
redundantGreet = undefined -- FIXME
...
ourMap f []     = undefined -- FIXME
ourMap f (x:xs) = undefined -- FIXME
...
ourFilter p []     = undefined -- FIXME
ourFilter p (x:xs) = undefined -- FIXME
